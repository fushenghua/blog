define(function(require, exports, module) { //参数名字不能改
  ...
  exports.init =function() {   
     ...
     var op = {
        ...
        url: "/system/calendar/getCalendar" ,  
        quickAddUrl: "/system/calendar/quickAdd" ,  
        quickUpdateUrl: "/system/calendar/quickUpdate" ,  
        quickDeleteUrl:  "/system/calendar/quickDel" //快速删除日程的
...
//            var url = StrFormat("calendar/edit/{0}?start={2}&end={3}&isallday={4}&title={1}",data);           
            var url = StrFormat("/system/calendar/updatePage/{0}?start={2}&end={3}&isallday={4}&title={1}",data);           
