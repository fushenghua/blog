...
public class BlogArticleBo {
	 ...
	 * 作者
	 */
	private String author = "RTMAP Blog ";
	/**
	 * 阅读次数
	 */
	 ...
	 * 网页的关键词
	 */
	private String keyWords = "RTMAP Blog ,coding";
	/**
	 * 网页的描述
	 */
	private String description = "作为一个java程序员,RTMAP Blog 希望将自己懂得技术,包含但不限于nginx,tomcat,spring mvc,ssh等分享给大家。";
	...
	public String getHtmlTitle(){
		return this.getTitle() + "_博客_RTMAP Blog ";
	}
